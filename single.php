      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        ...
        <div class="left_content">
          <div class="single_page">
            ...
            <h1><?php the_title(); ?></h1>
            <div class="post_commentbox"> <a href="<?php the_permalink(); ?>"><i class="fa fa-user"></i><?php the_author_posts_link(); ?></a> <span><i class="fa fa-calendar"></i><?php _e('','newsfeed' ) . the_time( 'g:i A' ); ?></span> <a href="<?php the_permalink(); ?>"><i class="fa fa-tags"></i><?php the_category(', '); ?></a> </div>
           ...
           <?php get_template_part('template-parts/comment', get_post_type() ); ?>
