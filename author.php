      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            ?>
            <div class="row">
            <h1 class="post_commentbox"><?php echo $curauth->nickname; ?> : All Posts <?php echo get_the_author_posts(); ?></h1>
            ...
            <div class="author-title"><a href="<?php the_permalink(); ?>"> <?php the_title(); ?></div>
